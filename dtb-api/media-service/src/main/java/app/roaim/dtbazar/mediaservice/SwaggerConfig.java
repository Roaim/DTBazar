package app.roaim.dtbazar.mediaservice;

import app.roaim.dtbazar.mediaservice.domain.ErrorBody;
...
public class SwaggerConfig {
    ...
    public Docket api(TypeResolver typeResolver) {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .host(gatewayUrl)
                .select()
                .apis(RequestHandlerSelectors.basePackage("app.roaim.dtbazar.mediaservice.controller"))
    ...
    private SecurityContext securityContext() {
        return SecurityContext.builder()
                ...
                .forPaths(PathSelectors.regex("/media.*"))
                .build();
    }
